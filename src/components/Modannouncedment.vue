...
<template>
    ...
    <div class="flex flex-col md:flex-row">
        <div class="w-full md:w-[80%] mx-auto md:mx-[10%]">
            ...
            <div class="px-5 pt-10 pb-2 m-auto mt-5 bg-white border-2 rounded-lg md:px-20 text-purpleCustom1">
                <form action="" class="w-full" @submit="sendSubmit">
                    <div class="flex flex-col md:flex-row">
                        ...
                        <input v-model="announcementTitle"
                            class="w-full ml-2 bg-gray-200 border-2 rounded-md md:w-3/4 md:ml-2 ann-title" maxlength="200"
                            required type="text" />
                    </div>
                    ...
                    <div class="flex flex-col mt-2 md:flex-row">
                        ...
                        <select v-model="categoryId"
                            class="w-full ml-2 bg-gray-200 shadow-md md:w-3/4 md:ml-2 shadow-slate-300 ann-category"
                            required>
                    ...
                    <div class="flex flex-col mt-6 md:flex-row">
                        ...
                        <div class="flex w-full space-x-4 md:w-3/4">
                            <input v-model="publishDate" :placeholder="'  ' + comeDate + ''"
                                class="w-1/2 py-1 ml-2 bg-gray-200 border-2 rounded-md md:w-1/4 ann-publish-date"
                                type="date" />
                            <input v-model="publishTime" :class="checkDisableTime(publishDate) ? 'opacity-50' : ''"
                                ...
                                class="w-1/2 py-1 ml-2 bg-gray-200 border-2 rounded-md md:w-1/4 ann-publish-time"
                                type="time" />
                        </div>
                    </div>
                    <div class="flex flex-col mt-6 md:flex-row">
                        ...
                        <div class="flex w-full space-x-4 md:w-3/4">
                            <input v-model="closeDate" :placeholder="'  ' + comeDate + ''"
                                class="w-1/2 py-1 ml-2 bg-gray-200 border-2 rounded-md md:w-1/4 ann-close-date"
                                type="date" />
                            <input v-model="closeTime" :class="checkDisableTime(closeDate) ? 'opacity-50' : ''"
                                ...
                                class="w-1/2 py-1 ml-2 bg-gray-200 border-2 rounded-md md:w-1/4 ann-close-time"
                                type="time" />
                        </div>
                    </div>
