    ...
    <div
      ...
      <div class="flex flex-row flex-grow">
        ...
        <div class="flex flex-grow overflow-hidden">
          <div class="pt-1 my-auto w-52 xl:1/2 ">
            <p class="pl-2 my-auto text-left ann-title hover:animate-marquee whitespace-nowrap max-h-16">
      ...
      <div class="flex flex-col w-64 lg:ml-20 ">
        <div class="text-left">
      ...
      <div class="flex flex-row">
        ...
        <div class="w-24 my-auto">views: {{ annData.viewCount }}</div>
