...
<template>
    <div class="h-auto min-w-full min-h-screen pt-5 lg:px-36 lg:pt-12">
        ...
        <div v-else class="flex pt-16 flex-col lg:flex-row ">
            <div class="min-w-full flex-col  flex h-8 lg:hidden">
                <p class="py-1 text-xl font-normal ">Date/Time shown in Timezone: <span class="font-normal">{{
                    timezone
                    }}</span></p>

                <div class="flex  flex-row">
                    <p class=" text-xl  my-auto w-1/2">Choose Category:</p>
                    <div class="flex flex-col">
                        <select
                                v-model="store.category"
                                class="text-black shadow-md shadow-slate-300 ann-category-filter ml-2  my-auto w-24">
            ...
            <div class="pl-32 lg:basis-1/3 hidden lg:block">
                <p class="py-1 text-xl font-normal ">Date/Time shown in Timezone: <span class="font-normal">{{
                    timezone
                    }}</span></p>
